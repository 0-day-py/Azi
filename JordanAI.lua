...
local MODEL_ALIASES = {
    ...
    openrouter = {
        ["nvidia/nemotron-3.5-lightning:free"] = "nemotron35_lightning",
        ["liquid/lfm-2.5-2.6b:free"] = "lfm25_2b",
        ["nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free"] = "nemotron3_nano_omni",
...
local function buildSystemPrompt(speakerName)
    ...
    return "You control this Roblox character." .. gameText .. " You are talking with " .. speakerName
        .. " (you may use their name). Current tools: " .. toolsText .. ". "
        ...
        .. "[ACTION:TILTHEAD] [ACTION:WIGGLE] [ACTION:TPOSE]. "
        .. "[ACTION:SPIN] spins 5s. [ACTION:SIT] / [ACTION:STANDUP]. [ACTION:STOP] cancels a dance/spin/emote. "
        ...
        .. "For LOOKAT/VISIT/FOLLOW/FLYFOLLOW/HIT, use NEAREST or FURTHEST in place of a username when asked "
        .. "for the closest/farthest player. "
        .. "Only add a tag for a genuine request — never guess, never more than one unrelated tag per request. "
        .. "Keep replies short."
end
