...
local function buildSystemPrompt(speakerName)
    ...
    return "You control this Roblox character. You are currently talking with " .. speakerName .. "; "
        ...
        .. "times' or 'jump twice'), you MUST use a single [ACTION:JUMP:N] tag with N as a digit for the exact "
        .. "count requested (max 5, e.g. 'twice' is [ACTION:JUMP:2], 'jump 3 times' is [ACTION:JUMP:3]) — never "
        .. "repeat separate [ACTION:JUMP] tags for this. For emotes/gestures add "
